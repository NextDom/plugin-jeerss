        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="vitesse"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="espacement_flux"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <label class="col-lg-3 control-label">{{Dimensions du Widget}}</label>
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                        <input type="range" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="taille" max="100" min="10" step="5" />
                        <output></output>
                        <script>
                        $(function() {
